...
# These are in the testbench directory, but are useful as a responder VC
analyze  ../tb/maintenance_tb/axilite_slave_model_pkg.vhd
analyze  ../tb/maintenance_tb/axilite_slave_model.vhd
